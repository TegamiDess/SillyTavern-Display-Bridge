...
Experimental, PC-first SillyTavern extensions for importing CHARX images and recognized Risu-style UI. **Display Bridge 0.14.2 / V3 Asset Sprites 0.6.4**.

Supported families include common portrait/dialogue layouts, reviewed composed scenes, Community-style profile panels, and streamer/Witchcure panels. Matching is based on supported source structure or an explicit profile, not author identity. General Lua/STscript, story-state automation and conditional greeting selection are not implemented.

...
export const event_types = Object.fromEntries(['GENERATION_AFTER_COMMANDS','MESSAGE_RECEIVED','GENERATION_STARTED','GENERATION_STOPPED','APP_READY','CHAT_CHANGED','CHARACTER_MESSAGE_RENDERED','USER_MESSAGE_RENDERED','MESSAGE_EDITED','MESSAGE_UPDATED','MESSAGE_SWIPED','MESSAGE_DELETED','MORE_MESSAGES_LOADED','GENERATION_ENDED','SETTINGS_UPDATED','CHARACTER_DELETED','CHARACTER_RENAMED','CHARACTER_EDITED','CHAT_CREATED'].map(x=>[x,x]));
